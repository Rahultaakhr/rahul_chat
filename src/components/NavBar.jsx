...
function NavBar() {
  ...
  return (
    <div>
        ...
        <h1 className="logo font-bold text-white ">Rahul Chat</h1>
        ...
        <button className=" bg-[#372fa2] text-white px-3 py-2 rounded-xl shadow-lg" onClick={logoutFunction}>Logout</button>
        </div>
